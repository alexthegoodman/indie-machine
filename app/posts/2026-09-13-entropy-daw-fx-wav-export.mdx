...
- A proper piano-roll rebuild on `TrackView`/`KeyframeTimeline` (see [the keyframe timeline and track view post](/posts/2026-09-12-entropy-keyframe-timeline-track-view)) instead of the DAW's current bespoke `PianoRoll` widget.
- MIDI input.
